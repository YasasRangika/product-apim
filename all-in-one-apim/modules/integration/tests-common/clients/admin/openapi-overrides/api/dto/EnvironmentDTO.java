...
public class EnvironmentDTO {
        ...
        @SerializedName(SERIALIZED_NAME_PERMISSIONS)
            ...
            /**
* For platform gateway environments (gatewayType Universal/APIPlatform), connection status to the control plane (Active or Inactive).
*/
...
public static StatusEnum fromValue(String value) {
    ...
    public StatusEnum read(final JsonReader jsonReader) throws IOException {
        ...
        public static final String SERIALIZED_NAME_PLATFORM_GATEWAY_VERSIONS = "platformGatewayVersions";
        @SerializedName(SERIALIZED_NAME_PLATFORM_GATEWAY_VERSIONS)
            private List<String> platformGatewayVersions = null;
    ...
    **/
        @javax.annotation.Nullable
      @ApiModelProperty(example = "Active", value = "For platform gateway environments (gatewayType Universal/APIPlatform), connection status to the control plane (Active or Inactive).")
    ...
    **/
    ...
    public boolean equals(Object o) {
        ...
        return false;
            ...
            Objects.equals(this.platformGatewayVersions, environment.platformGatewayVersions);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, displayName, description, provider, gatewayType, isReadOnly, apiDiscoveryScheduledWindow, vhosts, endpointURIs, additionalProperties, permissions, status, vhost, platformGatewayVersions);
    }
